...
>[!IMPORTANT]
>[Hyper-v](https://docs.microsoft.com/en-us/virtualization/hyper-v-on-windows/about/) 기능은 뿐 아니라 더 많은 컨테이너 수 있는 일반적인 가상화 기능입니다. Hyper-v 기능을 비활성화 하기 전에 없는 다른 가상화 구성 요소는 시스템에서 Hyper-v를 필요로 하는 있는지 확인 합니다.
