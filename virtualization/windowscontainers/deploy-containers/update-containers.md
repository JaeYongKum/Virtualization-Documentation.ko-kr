...
각 릴리스에 대해 각 컨테이너 이미지는 수정 번호에 대 한 두 개의 추가 태그 및 특정 컨테이너 이미지 수정 버전을 대상으로 하는 KB 문서 번호를 사용 하 여 게시 됩니다. 예를 들어:
...
|---|---|---|---|
| Windows Server 2016 (ltsc2016) | 10.0.14393.3443 (B4534271) | 10.0.14393.3506 (KB4546850) | 출시 될 컨테이너 (일) |
