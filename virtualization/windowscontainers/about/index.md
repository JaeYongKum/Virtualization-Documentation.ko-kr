...
![부엌 비유 하자면](media/box1.png)

이 컨테이너를 가져와서 우리가 원하는 호스트 아파트에 배치하면 똑같은 부엌이 됩니다. 작업을 수행 해야 하는 전기와에 연결한 니 (매우 많기 때문 필요한 모든 기기!) 요리를 시작할 합니다.

![아파트 비유 하자면](media/apartment.png)
